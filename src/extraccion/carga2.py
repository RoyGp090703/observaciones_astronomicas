...
# Definición de parámetros de consulta para la API de Small-Body
parametros = {
...
# Solicitud de datos a la base de datos de cuerpos menores (JPL)
respuesta = requests.get("https://ssd-api.jpl.nasa.gov/sbdb_query.api", params=parametros).json()

# Creación del DataFrame a partir de la respuesta
df_jpl = pd.DataFrame(respuesta["data"], columns=respuesta["fields"])

# Conversión automática de columnas a formato numérico
